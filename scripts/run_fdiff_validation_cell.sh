#!/bin/bash
# =============================================================================
# run_fdiff_validation_cell.sh  —  single-cell DAILY re-run of the Historical
# 2000-2019 transient (restart_1999.lpj) that ALSO emits the canopy STRUCTURE +
# LIGHT boundary conditions F_diff needs, so the differentiable fast core can be
# validated against the LPJmL-FIT C binary "same physics" on ONE prototype cell.
#
